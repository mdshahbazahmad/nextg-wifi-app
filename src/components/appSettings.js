 ...
 * Features: REAL Working Theme, Language Switch (EN/HI/UR), App Lock (PIN/Pattern/Fingerprint) & LocalStorage Persistence
 */
...
const TRANSLATIONS = {
    en: {
        ...
        securitySection: "🔒 App Security & Lock",
        enableLockLabel: "Enable App Lock",
        enableLockSub: "Protect app access with security lock",
        lockTypeLabel: "Lock Mechanism",
        lockTypeSub: "Select how you want to unlock the app",
        pinOpt: "🔢 4-Digit PIN",
        patternOpt: "📐 Pattern Lock",
        bioOpt: "👆 Fingerprint / Biometric",
        setPinLabel: "Set 4-Digit PIN",
        setPinSub: "Enter a secret 4-digit code",
        savePinBtn: "💾 Save Security Settings",
    ...
    hi: {
        ...
        securitySection: "🔒 ऐप सुरक्षा और लॉक",
        enableLockLabel: "ऐप लॉक सक्षम करें",
        enableLockSub: "सुरक्षा लॉक के साथ ऐप एक्सेस को सुरक्षित करें",
        lockTypeLabel: "लॉक का प्रकार",
        lockTypeSub: "आप ऐप को कैसे अनलॉक करना चाहते हैं चुनें",
        pinOpt: "🔢 4-अंकीय पिन (PIN)",
        patternOpt: "📐 पैटर्न लॉक",
        bioOpt: "👆 फिंगरप्रिंट / बायोमेट्रिक",
        setPinLabel: "4-अंकीय पिन सेट करें",
        setPinSub: "अपना गुप्त 4-अंकीय कोड दर्ज करें",
        savePinBtn: "💾 सुरक्षा सेटिंग्स सहेजें",
    ...
    ur: {
        ...
        securitySection: "🔒 ایپ سیکیورٹی اور لاک",
        enableLockLabel: "ایپ لاک فعال کریں",
        enableLockSub: "سیکیورٹی لاک کے ساتھ ایپ تک رسائی کو محفوظ بنائیں",
        lockTypeLabel: "لاک کی قسم",
        lockTypeSub: "منتخب کریں کہ آپ ایپ کو کیسے ان لاک کرنا چاہتے ہیں",
        pinOpt: "🔢 4 ہندسوں کا پن (PIN)",
        patternOpt: "📐 پیٹرن لاک",
        bioOpt: "👆 فنگر پرنٹ / بائیو میٹرک",
        setPinLabel: "4 ہندسوں کا پن سیٹ کریں",
        setPinSub: "اپنا خفیہ 4 ہندسوں کا کوڈ درج کریں",
        savePinBtn: "💾 سیکیورٹی ترجیحات محفوظ کریں",
...
const defaultSettings = {
    ...
    securityType: "pin", // 'pin', 'pattern', 'biometric'
    securityPin: "1234",
...
function renderAppSettingsComponent(containerElement) {
    ...
    const isRtl = settings.language === 'ur'; // Right-to-Left formatting for Urdu
                    ...
                    ${settings.securityType === 'pin' ? `
                        <div class="setting-item" style="flex-direction: column; align-items: flex-start; gap: 10px;">
                            ...
                            <div style="display: flex; gap: 10px; width: 100%;">
                                <input type="password" id="appPinInput" maxlength="4" value="${settings.securityPin}" placeholder="****" class="settings-input" style="width: 120px; text-align: center; letter-spacing: 4px;">
                                <button class="action-btn save-btn" onclick="saveSecurityPin()">${lang.savePinBtn}</button>
                            </div>
                        </div>
                    ` : ''}
                ` : ''}
...
window.saveSecurityPin = function() {
    ...
    if (pinInput && pinInput.value.length === 4) {
        window.nextgAppSettings.securityPin = pinInput.value;
        saveAppSettings();
        const msg = window.nextgAppSettings.language === 'hi' ? "🔒 4-अंकीय पिन सफलतापूर्वक सहेजा गया!" : 
                    (window.nextgAppSettings.language === 'ur' ? "🔒 4 ہندسوں کا پن کامیابی سے محفوظ ہو گیا!" : "🔒 4-Digit Security PIN Saved!");
        alert(msg);
    } else {
